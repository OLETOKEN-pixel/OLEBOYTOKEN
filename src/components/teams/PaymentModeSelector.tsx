  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      >
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-[12px] bg-[#ff1654]/20 text-[#ff6a8f]">
              <User className="h-4 w-4" />
            </div>
            <div>
              <h4 className="text-[15px] font-semibold leading-none text-white">Cover All</h4>
              <p className="mt-1 text-[13px] leading-[1.1] text-white/60">You lock the full team amount.</p>
            </div>
          </div>
          ...
          <div className="shrink-0 text-right">
            <div className="flex items-center justify-end gap-2 text-white">
              ...
              <span className="text-[16px] font-bold md:text-[18px]">{totalCost.toFixed(2)}</span>
            </div>
        ...
        {!canCover && (
          <div className="mt-3 rounded-[14px] border border-red-500/30 bg-red-500/10 px-3 py-2">
            <div className="flex items-center gap-2 text-[12px] leading-[1.2] text-red-200">
      ...
      >
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-[12px] bg-white/10 text-white/75">
              <Users className="h-4 w-4" />
            </div>
            <div>
              <h4 className="text-[15px] font-semibold leading-none text-white">Split Pay</h4>
              <p className="mt-1 text-[13px] leading-[1.1] text-white/60">Each member locks their own share.</p>
            </div>
          </div>
          ...
          <div className="shrink-0 text-right">
            <div className="flex items-center justify-end gap-2 text-white">
              <Coins className="h-4 w-4 text-[#ff6a8f]" />
              <span className="text-[16px] font-bold md:text-[18px]">{entryFee.toFixed(2)}</span>
            </div>
